  ...
  function buildHTML() {
    container.innerHTML = `
      <div id="othello-controls" style="margin-bottom:12px;max-width:576px;">
        <div id="othello-mode-selector" style="margin-bottom:8px;display:flex;justify-content:center;gap:6px;flex-wrap:wrap;">
        ...
        <div id="othello-time-selector" style="margin-bottom:8px;display:none;justify-content:center;gap:6px;flex-wrap:wrap;">
